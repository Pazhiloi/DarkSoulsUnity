...
namespace MR
{
    ...
    public override State Tick(AICharacterManager aiCharacter)
    {
      ...
      {
        aiCharacter.enemyAnimatorManager.PlayTargetAnimationWithRootRotation("Turn_Behind", true);
      ...
      {
        aiCharacter.enemyAnimatorManager.PlayTargetAnimationWithRootRotation("Turn_Right", true);
        return combatStanceState;
      }
      else if (aiCharacter.viewableAngle >= 45 && aiCharacter.viewableAngle <= 100 && !aiCharacter.isInteracting)
      {
        aiCharacter.enemyAnimatorManager.PlayTargetAnimationWithRootRotation("Turn_Left", true);
        return combatStanceState;
      }
      return combatStanceState;
    }
